...
3. [3_containers_and_orchestration](3_containers_and_orchestration) - Docker, Kaniko, Kubernetes, Nomad, kind, stern, trivy, dive, lazydocker
4. [4_monitoring_and_log_tools](4_monitoring_and_log_tools) - Elasticsearch, rsyslog, k6, grpcurl
